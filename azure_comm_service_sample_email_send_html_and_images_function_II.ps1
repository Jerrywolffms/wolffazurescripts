...
    )
 ...
 send_custom_message  -imagepath "C:\temp\jac_skeleton_from_nightma.JPEG" -filepath "C:\temp\azstorage.html" -messagetext "jack is back" -subject "customdomain test" -to "jerrywolff@microsoft.com"
